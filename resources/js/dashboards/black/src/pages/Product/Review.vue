<template>
  <datatable
    ...
    <template v-slot:product-body="slotProps">
    ...
    <template v-slot:advantages-body="slotProps">
      <ul :style="{listStyleType: 'circle'}" class="text-success">
        <li v-for="(item, index) in slotProps.row.advantages" :key="index">{{ item }}</li>
      </ul>
    </template>

    <template v-slot:disadvantages-body="slotProps">
      <ul :style="{listStyleType: 'circle'}" class="text-danger">
        <li v-for="(item, index) in slotProps.row.disadvantages" :key="index">{{ item }}</li>
      </ul>
    </template>

    <template v-slot:ranks-body="slotProps">
      <ul :style="{listStyleType: 'circle'}" class="text-danger">
        <li v-for="(item, index) in slotProps.row.disadvantages" :key="index">{{ item }}</li>
      </ul>
    </template>
